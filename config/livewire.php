...
return [
    ...
    */
    ...
    |
    | Overridden from the package default ('layouts::app', which resolves to a
    | 'layouts' view namespace this app never registers - every full-page
    | Livewire route would 500 with "No hint path defined for [layouts]" on
    | real HTTP requests, silently unnoticed because Livewire::test() bypasses
    | this route-level layout wrapping entirely). This app's actual page shell
    | is the `<x-layout>` Blade component at resources/views/components/layout.blade.php.
    |
    */

<div class="rounded-card border border-line p-4 space-y-4 max-w-xl">
    ...
    <div class="grid grid-cols-2 gap-3">
        ...
        <div>
            ...
            @error('eventRoleSetId') <p class="text-danger text-xs mt-1">{{ $message }}</p> @enderror
        </div>
    </div>
    ...
    <div>
        ...
        @elseif ($event->image_url)
            <img src="{{ $event->image_url }}" alt="Current image" class="mt-2 h-24 rounded-control object-cover">
        @endif
    </div>

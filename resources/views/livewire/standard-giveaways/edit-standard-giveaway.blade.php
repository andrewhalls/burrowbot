<div class="rounded-card border border-line p-4 space-y-4 max-w-xl">
    ...
    @include('partials.image-upload-field', ['fieldLabel' => 'Banner image (optional)', 'fieldModel' => 'bannerImage', 'fieldFile' => $bannerImage, 'fieldCurrentUrl' => $giveaway->banner_image_url])

    @include('partials.image-upload-field', ['fieldLabel' => 'Image (optional)', 'fieldModel' => 'image', 'fieldFile' => $image, 'fieldCurrentUrl' => $giveaway->image_url])
